...
public class UserInforController {
    ...
    @RequestMapping("resetPasswordByPrimaryKey.do")
    @ResponseBody
    public Map<String,String> resetPasswordByPrimaryKey(String id,HttpSession httpSession){
        System.out.println("需要重置密码的员工的id为：===="+id);
        HashMap<String, String> map = new HashMap<String, String>();
//        Integer eid = (Integer) httpSession.getAttribute("employeeId");
        Integer eid = null;
        if (id !=null){
...
//        System.out.println("Integer id为：===="+eid);
        userInforService.resetPassword(eid);
        map.put("status","1");
        map.put("msg","密码修改成功");
        return map;
